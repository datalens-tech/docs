...
| Name | Description |
----- | -----
| Axis name | Sets an axis label.<br/><br/>Possible values:<br/>**Auto**: Uses a field name. If the section contains several fields, DataLens uses the name of the field specified first in the list.<br/>**Manually**: Allows you to set an axis name manually in a text field.<br/>**Off**: No axis label. |
