---
title: Фильтрация чартов чартами в {{ datalens-full-name }}
description: В статье описано, как в {{ datalens-full-name }} настроить фильтрацию чартов другими чартами.
---

# Фильтрация чартов чартами в {{ datalens-full-name }}
