---
title: Виджеты в {{ datalens-full-name }}
description: Виджет в {{ datalens-full-name }} – это элемент дашборда. Между виджетами Селектор и Чарт можно строить связи.
---

# Виджеты в {{ datalens-full-name }}
