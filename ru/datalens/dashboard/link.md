---
title: Связь в {{ datalens-full-name }}
description: Связь в {{ datalens-full-name }} определяет влияние селектора на один или несколько чартов, а также на другие селекторы.
---

# Связь в {{ datalens-full-name }}
...
Тип связи определяет, как будут отфильтрованы значения в селекторах и чартах. Тип задается в окне связей в режиме редактирования дашборда. Подробнее о том, как настроить связь, читайте в разделе [{#T}](../operations/dashboard/dashboard-links.md).
