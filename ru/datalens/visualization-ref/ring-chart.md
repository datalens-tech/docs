---
title: Кольцевая диаграмма в {{ datalens-full-name }}
description: Из статьи вы узнаете, как в {{ datalens-full-name }} создать и настроить тип визуализации Кольцевая диаграмма.
---

# Кольцевая диаграмма ![](../../_assets/datalens/ring.svg) в {{ datalens-full-name }}
