---
title: Как добавить параметр в чарт {{ datalens-full-name }}
description: Следуя данной инструкции, вы сможете добавить параметр в чарт {{ datalens-full-name }}.
---

# Добавление параметра в чарт {{ datalens-full-name }}
