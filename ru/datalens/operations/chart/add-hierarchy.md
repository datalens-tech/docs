...
1. На главной странице {{ datalens-short-name }} нажмите **Создать чарт**.
...
1. В левой части интерфейса визарда нажмите значок **![image](../../../_assets/console-icons/plus.svg)** и выберите **Добавить иерархию**.
