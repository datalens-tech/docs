---
title: Создание цветовой палитры в {{ datalens-full-name }}
description: Следуя данной инструкции, вы сможете создать цветовую палитру в {{ datalens-full-name }}.
---

# Создание цветовой палитры в {{ datalens-full-name }}
