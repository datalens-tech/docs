---
title: Как добавить текст на дашборд в {{ datalens-full-name }}
description: Следуя данной инструкции, вы сможете добавить текст на дашборд в {{ datalens-full-name }}.
---

# Добавление текста на дашборд в {{ datalens-full-name }}
